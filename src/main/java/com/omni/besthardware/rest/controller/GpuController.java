...
public class GpuController {
    ...
    @GetMapping
    public List<GpuResponse> listar(@ModelAttribute GpuFiltroRequest filtro) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<GpuResponse> buscarPorId(@PathVariable Integer id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<GpuResponse> atualizar(@PathVariable Integer id, @Valid @RequestBody GpuRequest request) {
